    ...
    public function get_comment_author_avatar($comment = null) {
        ...
        if ($comment) {
            ...
            if ($comm_auth_user_email) {
                ...
                $comm_auth_avatar = '<img width="48" height="48" class="avatar avatar-48 photo avatar-default" src="' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/avatar_default.png') . '" alt=""/>';
            }
        }
