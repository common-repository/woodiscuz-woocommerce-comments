...
class WPC_Comment_Template_Builder {
    ...
    public function get_comment_template($comment, $args, $depth) {
        ...
        if ($wpc_profile_url) {
            $wpc_comm_author_avatar = "<a target='_blank' href='".esc_attr($wpc_profile_url)."'>" . $this->wpc_helper->get_comment_author_avatar($comment) . "</a>";
            $wpc_author_name = "<a target='_blank' href='".esc_attr($wpc_profile_url)."'>" . esc_html($wpc_author_name) . "</a>";
        }
        ...
        if (!$this->wpc_options_serialized->wpc_author_titles_show_hide) {
            $output .= '<div class="wpc-comment-label">' . esc_html($author_title) . '</div>';
        }
        $output .= '</div>';
        $output .= '<div class="wpc-comment-right">';
        $output .= '<div class="wpc-comment-header"><div class="wpc-comment-author">' . $wpc_author_name . '</div><div class="wpc-comment-date">' . esc_html($posted_date) . '</div><div style="clear:both"></div></div>';
        ...
        if (!$this->wpc_options_serialized->wpc_voting_buttons_show_hide) {
            $output .= '<div id="vote-count-' . $unique_id . '" class="wpc-vote-result">' . esc_html($vote_count) . '</div>';
            $output .= '<span id="wpc-up-' . $unique_id . '" class="wpc-vote-link wpc-up ' . esc_attr($vote_cls) . '" title="' . esc_attr($vote_up) . '">&and;</span> | <span id="wpc-down-' . $unique_id . '" class="wpc-vote-link wpc-down ' . esc_attr($vote_cls) . '" title="' . esc_attr($vote_down) . '">&or;</span> &nbsp;&nbsp;';
        }
        ...
        if ($this->wpc_options_serialized->wpc_reply_button_only_author_show && ($wpc_is_author || $wpc_is_logged_in_poster || $wpc_is_poster_guest)) {
            if ($this->is_guest_can_reply() && !get_current_user_id()) {
                $output .= '&nbsp;&nbsp;<span id="wpc-comm-reply-' . $unique_id . '" class="wpc-reply-link" title="' . esc_attr($wpc_reply_text) . '">' . esc_html($wpc_reply_text) . '</span> &nbsp;&nbsp;';
        ...
        if (!$this->wpc_options_serialized->wpc_share_buttons_show_hide) {
            $output .= '-&nbsp;&nbsp; <span id="wpc-comm-share-' . $unique_id . '" class="wpc-share-link" title="' . esc_attr($wpc_share_text) . '">' . esc_html($wpc_share_text) . '</span> &nbsp;&nbsp;';
            ...
            $output .= '<a target="_blank" href="http://www.facebook.com/sharer.php?u=' . $wpc_post_permalink . '" title="' . esc_attr($this->wpc_options_serialized->wpc_phrases['wpc_share_facebook']) . '"><img src="' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/fb-18x18.png') . '" onmouseover="this.src=\'' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/fb-18x18-orig.png') . '\'" onmouseout="this.src=\'' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/fb-18x18.png') . '\'"/></a>&nbsp;&nbsp;';
            $output .= '<a target="_blank" href="https://twitter.com/home?status=' . $twitt_content . '" title="' . esc_attr($this->wpc_options_serialized->wpc_phrases['wpc_share_twitter']) . '"><img src="' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/twitter-18x18.png') . '" onmouseover="this.src=\'' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/twitter-18x18-orig.png') . '\'" onmouseout="this.src=\'' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/twitter-18x18.png') . '\'"/></a>&nbsp;&nbsp;';
            $output .= '<a target="_blank" href="https://plus.google.com/share?url=' . $wpc_post_permalink . '" title="' . esc_attr($this->wpc_options_serialized->wpc_phrases['wpc_share_google']) . '"><img src="' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/google-18x18.png') . '" onmouseover="this.src=\'' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/google-18x18-orig.png') . '\'" onmouseout="this.src=\'' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/google-18x18.png') . '\'"/></a>&nbsp;&nbsp;';
            $output .= '<a target="_blank" href="http://vk.com/share.php?url=' . $wpc_post_permalink . '" title="' . esc_attr($this->wpc_options_serialized->wpc_phrases['wpc_share_vk']) . '"><img src="' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/vk-18x18.png') . '" onmouseover="this.src=\'' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/vk-18x18-orig.png') . '\'" onmouseout="this.src=\'' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/vk-18x18.png') . '\'"/></a>&nbsp;&nbsp;';
            $output .= '<a target="_blank" href="http://www.odnoklassniki.ru/dk?st.cmd=addShare&st.s=1&st._surl=' . $wpc_post_permalink . '" title="' . esc_attr($this->wpc_options_serialized->wpc_phrases['wpc_share_ok']) . '"><img src="' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/ok-18x18.png') . '" onmouseover="this.src=\'' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/ok-18x18-orig.png') . '\'" onmouseout="this.src=\'' . plugins_url(WOODISCUZ_DIR_NAME . '/files/img/social-icons/ok-18x18.png') . '\'"/></a>&nbsp;&nbsp;';
            $output .= '</span>';
        }
        ...
        if (current_user_can('edit_comment', $comment->comment_ID)) {
            ...
            if ($this->wpc_helper->is_comment_editable($comment) && $current_user->ID && $current_user->ID == $comment->user_id) {
                $output .= '<span id="wpc_editable_comment-' . $unique_id . '" class="wpc_editable_comment">-&nbsp;&nbsp;' . esc_html($this->wpc_options_serialized->wpc_phrases['wpc_edit_text']) . '</span>';
                $output .= '<span id="wpc_cancel_edit-' . $unique_id . '" class="wpc_cancel_edit">-&nbsp;&nbsp;' . esc_html($this->wpc_options_serialized->wpc_phrases['wpc_comment_edit_cancel_button']) . '</span>';
                $output .= '<span id="wpc_save_edited_comment-' . $unique_id . '" class="wpc_save_edited_comment" style="display:none;">&nbsp;&nbsp;-&nbsp;&nbsp;' . esc_html($this->wpc_options_serialized->wpc_phrases['wpc_comment_edit_save_button']) . '</span>';
            }
        }
        ...
        if (!$comment->comment_parent && count($child_comments)) {
            $visibility = 'block';
            $output .= '<span id="wpc-toggle-' . $unique_id . '" class="wpc-toggle" style="display:' . $visibility . ';">' . esc_html($this->wpc_options_serialized->wpc_phrases['wpc_hide_replies_text']) . ' &and;</span>';
        }
        ...
        if ($this->is_form_visible()) {
            ...
            if (!is_user_logged_in()) {
                ...
                $output .= '<div class="wpc-author-data"><div class="wpc-field-name woodiscuz-item"><input id="wpc_name-' . $unique_id . '" name="wpc_name" class="wpc_name" ' . $wpc_is_name_field_required . ' value="" type="text" placeholder="' . esc_attr($this->wpc_options_serialized->wpc_phrases['wpc_name_text']) . '"/></div><div class="wpc-field-email woodiscuz-item"><input id="wpc_email-' . $unique_id . '" class="wpc_email email" name="wpc_email" ' . $wpc_is_email_field_required . ' value="" type="email" placeholder="' . esc_attr($this->wpc_options_serialized->wpc_phrases['wpc_email_text']) . '"/></div><div style="clear:both"></div></div>';
            }
			...
			if (!$this->wpc_options_serialized->wpc_reply_subscription_on_off) {
                ...
                $output .= '<label class="wpc-label-reply-notify" for="wpc_notification_new_reply-' . $unique_id . '">' . esc_html($this->wpc_options_serialized->wpc_phrases['wpc_notify_on_new_reply']) . '</label>';
                $output .= '</div>';
            }
			
			$output .= '<input type="button" name="submit" value="' . esc_attr($this->wpc_options_serialized->wpc_phrases['wpc_submit_text']) . '" id="wpc_comm-' . $unique_id . '" class="wpc_comm_submit button alt"/>
							</div>';
            $output .= '<div style="clear:both"></div>';
            $output .= '</div>';
