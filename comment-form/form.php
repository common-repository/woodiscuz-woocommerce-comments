...
if (isset($_GET['wooDiscuzSubscribeID']) && isset($_GET['key'])) {
    ...
    <div id="wpc_unsubscribe_message">
        <span class="wpc_unsubscribe_message"><?php echo esc_html($this->wpc_options_serialized->wpc_phrases['wpc_unsubscribe_message']); ?></span>
    </div>
    <?php
}
?>
...
if (isset($_GET['wooDiscuzConfirmID']) && isset($_GET['wooDiscuzConfirmKey']) && isset($_GET['wooDiscuzConfirm'])) {
    ...
    ?>
    <div id="wpc_unsubscribe_message">
        <span class="wpc_unsubscribe_message"><?php echo esc_html($this->wpc_options_serialized->wpc_phrases['wpc_confirm_success_message']); ?></span>
    </div>
    <?php
}
?>
...
<div id="woopcomm">
    <p class="wpc-comment-title"><?php echo esc_html($this->wpc_options_serialized->wpc_phrases['wpc_header_text']); ?></p>
    <div class="wpc-form-wrapper">
        ...
        if ($this->is_guest_can_comment()) {
            ...
            <form action="" method="post" id="wpc_comm_form-<?php echo $unique_id; ?>" class="wpc_comm_form wpc_main_form <?php echo $wpc_form_has_comments; ?>">
                <div class="wpc-field-comment">
                    ...
                    <div style="margin-left:65px;" class="woodiscuz-item"><textarea id="wpc_comment-<?php echo $unique_id; ?>" class="wpc_comment" name="wpc_comment" required placeholder="<?php echo esc_attr($textarea_placeholder); ?>"></textarea></div>
                    <div style="clear:both"></div>
                </div>
                <div id="wpc-form-footer-<?php echo $unique_id; ?>" class="wpc-form-footer">
                    <?php if (!is_user_logged_in()) { ?>
                        <div class="wpc-author-data">
                            <div class="wpc-field-name woodiscuz-item"><input id="wpc_name-<?php echo $unique_id; ?>" class="wpc_name" name="wpc_name" <?php echo $wpc_is_name_field_required; ?> value="" type="text" placeholder="<?php echo esc_attr($this->wpc_options_serialized->wpc_phrases['wpc_name_text']); ?>"/></div>
                            <div class="wpc-field-email woodiscuz-item"><input id="wpc_email-<?php echo $unique_id; ?>" class="wpc_email email" name="wpc_email" <?php echo $wpc_is_email_field_required; ?> value="" type="email" placeholder="<?php echo esc_attr($this->wpc_options_serialized->wpc_phrases['wpc_email_text']); ?>"/></div>
                            <div style="clear:both"></div>
                        </div>
                    <?php } ?>
                        ...
                        <?php if (!$this->wpc_options_serialized->wpc_captcha_show_hide) { ?>
                            <?php if (!is_user_logged_in()) { ?>
                                <div class="wpc-field-captcha woodiscuz-item">
                                    ...
                                    <span class="captcha_msg"><?php echo esc_html($this->wpc_options_serialized->wpc_phrases['wpc_captcha_text']); ?></span>
                                </div>
                            <?php } ?>
                        <?php } ?>
                        <div class="wpc-field-submit">
                            <?php if (!$this->wpc_options_serialized->wpc_reply_subscription_on_off) { ?>
                                <div class="wpc_notification_checkboxes" style="display: block;">
                                    ...
                                    <label class="wpc-label-reply-notify" for="wpc_notification_new_reply-<?php echo $unique_id; ?>"><?php echo esc_html($this->wpc_options_serialized->wpc_phrases['wpc_notify_on_new_reply']); ?></label>
                                </div>
                            <?php } ?>
                            <input type="button" name="submit" value="<?php echo esc_attr($this->wpc_options_serialized->wpc_phrases['wpc_submit_text']); ?>" id="wpc_comm-<?php echo $unique_id; ?>" class="wpc_comm_submit button alt"/>
                        </div>
                        <div style="clear:both"></div>
                    </div>
                </div>                           
        ...
        <?php } else { ?>
        <p class="wpc-must-login"><?php echo esc_html($this->wpc_options_serialized->wpc_phrases['wpc_you_must_be_text']); ?> <a href="<?php echo wp_login_url(); ?>"><?php echo esc_html($this->wpc_options_serialized->wpc_phrases['wpc_logged_in_text']); ?></a> <?php echo esc_html($this->wpc_options_serialized->wpc_phrases['wpc_to_post_comment_text']); ?></p>
        <?php } ?>
    ...
    <?php if ($wpc_parent_comments_count > $this->wpc_options_serialized->wpc_comment_count) { ?>
        <div class="wpc-load-more-submit-wrap">
            ...
            <input type="hidden" name="wpc_parent_per_page" id="wpc_parent_per_page" value="<?php echo esc_attr($this->wpc_options_serialized->wpc_comment_count); ?>" />
            <input type="hidden" name="wpc_parent_comments_count" id="wpc_parent_comments_count" value="<?php echo esc_attr($wpc_parent_comments_count); ?>" />
        </div>
    <?php } ?>
